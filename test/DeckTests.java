...
public class DeckTests {
    ...
    public void suitTest() {
        ...
        {
            if (temp.get(i).getSuit().equals("CLUB")) clubs.add(temp.get(i));
            else if (temp.get(i).getSuit().equals("SPADE")) spades.add(temp.get(i));
            else if (temp.get(i).getSuit().equals("HEART")) hearts.add(temp.get(i));
            else if (temp.get(i).getSuit().equals("DIAMOND")) diamonds.add(temp.get(i));
        }
